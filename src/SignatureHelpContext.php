...
class SignatureHelpContext
{
    ...
    {
        $this->$triggerKind = $this->$triggerKind;
        $this->$triggerCharacter = $this->$triggerCharacter;
        $this->$isRetrigger = $this->$isRetrigger;
        $this->$activeSignatureHelp = $this->$activeSignatureHelp;
    }
}